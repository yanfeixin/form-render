 ...
 * @LastEditTime: 2024-10-16 11:28:19
 * @Description:
 */
...
import { getLibPath, pkgRoot } from './paths'
/**
 ...
 * @returns string[]
 */
export async function generateExternal(buildType: 'node' | 'cdn') {
 ...
 * @returns plugins[]
 */
export function rollupBuildPlugins(minify?: boolean): InputPluginOption {
