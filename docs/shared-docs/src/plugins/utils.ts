 ...
 * @param componentName
 */
export function handleComponentName(componentName: string) {
 ...
 * @param componentName
 */
export function injectComponentImportScript(env: any, path: string, componentName: string) {
 ...
 * @returns
 */
export function transformHighlightCode(mdInstance: MarkdownIt, sourceCode: string, suffix: string) {
 ...
 * @returns
 */
export function isCheckingRelativePath(path: string) {
